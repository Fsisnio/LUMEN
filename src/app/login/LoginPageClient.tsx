...
type LoginPageClientProps = {
  /** Set from the server (`page.tsx`): false in production to avoid leaking demo credentials. */
  showDemoAccounts: boolean;
};

export function LoginPageClient({ showDemoAccounts }: LoginPageClientProps) {

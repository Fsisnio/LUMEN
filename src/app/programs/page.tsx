    ...
    <div className="min-h-screen bg-[var(--background)]">
      <header className="border-b border-[var(--border)] bg-[var(--card)] px-4 py-5 sm:px-6 lg:px-8 lg:py-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="font-display text-2xl font-semibold text-[var(--navy)] sm:text-3xl">{t("programs.title")}</h1>
            <p className="mt-1 text-gray-600">{t("programs.subtitle")}</p>
          </div>
          <button
            onClick={() => setModalProgram("new")}
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-[var(--accent)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--accent-dark)] sm:mt-1"
          >
